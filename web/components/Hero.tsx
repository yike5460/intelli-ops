    ...
    <section className="py-20 text-center bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center space-x-4">
          ...
          <a href="https://github.com/aws-samples/aws-genai-cicd-suite" target="_blank" rel="noopener noreferrer" className="bg-gray-200 text-gray-800 px-8 py-3 rounded-full font-bold hover:bg-gray-300 transition duration-300">Learn More</a>
        </div>
      </div>
    </section>
  );
